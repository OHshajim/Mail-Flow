...
export const RocketIcon = ({
    ...
    <svg
        ...
        className={className}
    >
    <path d="M2 17.075L3.975 16.275C3.80833 15.7917 3.65417 15.3 3.5125 14.8C3.37083 14.3 3.25833 13.8 3.175 13.3L2 14.1V17.075ZM6 16.025H10C10.3 15.3583 10.5417 14.5458 10.725 13.5875C10.9083 12.6292 11 11.65 11 10.65C11 9 10.725 7.4375 10.175 5.9625C9.625 4.4875 8.9 3.35 8 2.55C7.1 3.35 6.375 4.4875 5.825 5.9625C5.275 7.4375 5 9 5 10.65C5 11.65 5.09167 12.6292 5.275 13.5875C5.45833 14.5458 5.7 15.3583 6 16.025ZM8 11.025C7.45 11.025 6.97917 10.8292 6.5875 10.4375C6.19583 10.0458 6 9.575 6 9.025C6 8.475 6.19583 8.00417 6.5875 7.6125C6.97917 7.22083 7.45 7.025 8 7.025C8.55 7.025 9.02083 7.22083 9.4125 7.6125C9.80417 8.00417 10 8.475 10 9.025C10 9.575 9.80417 10.0458 9.4125 10.4375C9.02083 10.8292 8.55 11.025 8 11.025ZM14 17.075V14.1L12.825 13.3C12.7417 13.8 12.6292 14.3 12.4875 14.8C12.3458 15.3 12.1917 15.7917 12.025 16.275L14 17.075ZM8 0C9.65 1.2 10.8958 2.725 11.7375 4.575C12.5792 6.425 13 8.575 13 11.025L15.1 12.425C15.3833 12.6083 15.6042 12.85 15.7625 13.15C15.9208 13.45 16 13.7667 16 14.1V20.025L11.025 18.025H4.975L0 20.025V14.1C0 13.7667 0.0791667 13.45 0.2375 13.15C0.395833 12.85 0.616667 12.6083 0.9 12.425L3 11.025C3 8.575 3.42083 6.425 4.2625 4.575C5.10417 2.725 6.35 1.2 8 0Z" 
    fill={color}/>
    </svg>
);